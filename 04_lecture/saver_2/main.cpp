// Kompajliranje:
// g++ -o saver_2 saver_2.cpp util.cpp util_t.cpp -lGLEW -lGL -lGLU -lglut -lpthread
...
bool init_data()
{
	...
	programID_t = s.load_shaders({
        "SimpleVertexShader1.vert", "SimpleFragmentShader.frag","", "TessCont.tesc", "TessEval.tese"});
...
void myDisplay()
{
	...
	glutTimerFunc(fps,myTimerFunc,1);
}
