...
bool linkShaders(GLuint &programID, GLuint vertexShaderID, GLuint fragmentShaderID, GLuint geometryShaderID) 
{
...
GLuint loadShaders(const char * vertex_file_path, const char * fragment_file_path, const char * geometry_file_path, GLuint *vertexShaderIDadr, GLuint *fragmentShaderIDadr) 
{
	...
	if(compiled) {
		compiled = linkShaders(programID, vertexShaderID, fragmentShaderID, geometryShaderID);
	}
